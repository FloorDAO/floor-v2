...
import {INFTXVaultFactory} from "@floor-interfaces/nftx/NFTXVaultFactory.sol";
import {IWETH} from "@floor-interfaces/tokens/WETH.sol";
import {IUniswapV2Router01} from "@floor-interfaces/uniswap/IUniswapV2Router01.sol";

contract NFTXUnstakingInventoryZap is INFTXUnstakingInventoryZap, Ownable, ReentrancyGuard {
    ...
    function unstakeInventory(
        ...
        if (vTokenRemainder > 100) {
            vToken.safeTransfer(recipient, vTokenRemainder);
        }

        emit InventoryUnstaked(vaultId, xTokensToPull, numNfts, recipient);
    }
