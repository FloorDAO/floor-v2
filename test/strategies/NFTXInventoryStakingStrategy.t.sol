...
contract NFTXInventoryStakingStrategyTest is Test {
     ...
     */
    function canGetYieldToken() public {}
     ...
     * contract.
     */
    function canClaimRewards() public {}
     ...
     */
    function canClaimRewardsWhenEmpty() public {}
     ...
     * from the strategy.
     */
    function canPartiallyExitPosition() public {}
     ...
     * strategy.
     */
    function canFullyExitPosition() public {}
     ...
     */
    function cannotExitBeyondPosition() public {}
     ...
     * a revert.
     */
    function cannotExitPositionWithZeroStake() public {}
     ...
     */
    function canDetermineRewardsAvailable() public {}
     ...
     */
    function canDetermineRewardsAvailableWhenZero() public {}

    /**
     * When we have generated yield we want to be sure that our helper
     * function returns the correct value.
     */
    function canCalculateTotalRewardsGenerated() public {}
